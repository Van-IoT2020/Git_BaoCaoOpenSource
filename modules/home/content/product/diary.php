<?php 
$stmt = $conn->prepare("SELECT * FROM product WHERE product_type_id = 3 AND status = 1 ORDER BY id DESC LIMIT 0,12");
$stmt->execute();
    ...
    <div class="container">
       <div class="row">
           <div class="col-md-12" style="text-align: center;margin-bottom:10px;">
                <a class="aa-browse-btn" href="index.php?p=product&type=3">Xem tất cả sản phẩm<span class="fa fa-long-arrow-right"></span></a>
           </div>
       </div>
   </div> 
</div>
